...
<div class="breadcrumb-area pt-255 pb-170"
    style="background-image: url({{ asset('assets/frontend/') }}/img/banner/banner-4.jpg)">
                    ...
                    <div class="product-details-tab mr-40">
                            ...
                            <div class="tab-pane" id="pro-details2">
                                <div class="easyzoom easyzoom--overlay">
                                    <a href="assets/img/product-details/bl2.jpg">
                                        <img src="{{ asset('assets/frontend/') }}/img/product-details/l2.jpg" alt="">
                                    </a>
                                </div>
                            </div>
                            <div class="tab-pane" id="pro-details3">
                                <div class="easyzoom easyzoom--overlay">
                                    <a href="assets/img/product-details/bl3.jpg">
                                        <img src="{{ asset('assets/frontend/') }}/img/product-details/l3.jpg" alt="">
                                    </a>
                                </div>
                            </div>
                            <div class="tab-pane" id="pro-details4">
                                <div class="easyzoom easyzoom--overlay">
                                    <a href="assets/img/product-details/bl4.jpg">
                                        <img src="{{ asset('assets/frontend/') }}/img/product-details/l4.jpg" alt="">
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="product-details-small nav mt-12 product-dec-slider owl-carousel">
                            <a class="active" href="#pro-details1">
                                <img src="{{ asset('assets/frontend/') }}/img/product-details/s1.jpg" alt="">
                            </a>
                            <a href="#pro-details2">
                                <img src="{{ asset('assets/frontend/') }}/img/product-details/s2.jpg" alt="">
                            </a>
                            <a href="#pro-details3">
                                <img src="{{ asset('assets/frontend/') }}/img/product-details/s3.jpg" alt="">
                            </a>
                            <a href="#pro-details4">
                                <img src="{{ asset('assets/frontend/') }}/img/product-details/s4.jpg" alt="">
                            </a>
                            <a href="#pro-details5">
                                <img src="{{ asset('assets/frontend/') }}/img/product-details/s3.jpg" alt="">
                            </a>
            ...
            <div class="col-lg-6">
                <div class="product-details-content">
                    ...
                    <div class="product-overview">
                        ...
                        <p>Lorem ipsum dolor sit amet, consectetur adipic it, sed do eiusmod tempor incididunt ut labore
