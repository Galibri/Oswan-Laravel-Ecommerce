...
<body>
    <div class="wrapper">
        <header>
            <div class="header-area transparent-bar ptb-55 stick">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-4">
                            <div class="logo-small-device">
                                <a href="{{ route('frontend.home') }}"><img alt=""
                                        src="{{ asset('assets/frontend/') }}/img/logo/logo.png"></a>
                            </div>
                        </div>
                                                        ...
                                                        <li class="mega-menu-img">
                                                            <ul>
                                                                <li><a class="dot-none" href="shop.html"><img alt=""
                                                                            src="{{ asset('assets/frontend/') }}/img/banner/17.jpg"></a>
                                                                </li>
                                                            </ul>
                                                        </li>
                                                    </ul>
                                    ...
                                    <ul>
                                        <li class="single-shopping-cart">
                                            <div class="shopping-cart-img">
                                                <a href="#"><img alt=""
                                                        src="{{ asset('assets/frontend/') }}/img/cart/cart-1.jpg"></a>
                                            </div>
                                        ...
                                        <li class="single-shopping-cart">
                                            <div class="shopping-cart-img">
                                                <a href="#"><img alt=""
                                                        src="{{ asset('assets/frontend/') }}/img/cart/cart-2.jpg"></a>
                                            </div>
                                            <div class="shopping-cart-title">
                                        ...
                                        <li class="single-shopping-cart">
                                            <div class="shopping-cart-img">
                                                <a href="#"><img alt=""
                                                        src="{{ asset('assets/frontend/') }}/img/cart/cart-3.jpg"></a>
                                            </div>
                                            <div class="shopping-cart-title">
                                                <h3><a href="#">Demonissi Gori</a></h3>
                                                <span>Price: $275</span>
                                            ...
                                            <ul>
                                                ...
                                                <li><a href="#">product details</a>
                                                    <ul>
                                                        ...
                                                        <li><a href="product-details-gallery.html">gallery style</a>
                                                        </li>
                                                        <li><a href="product-details-fixed-img.html">fixed image
                                                                style</a></li>
                                                    </ul>
                        ...
                        <div class="col-lg-3 col-md-6 col-12">
                            <div class="footer-widget mb-30">
                                <div class="footer-logo">
                                    <a href="index.html">
                                        <img src="{{ asset('assets/frontend/') }}/img/logo/2.png" alt="">
                                    </a>
                                </div>
                                <div class="footer-about">
                                    <p><span>OSWAN</span> the most latgest bike store in the wold can serve you latest
                            ...
                            <div class="quick-view-learg-img">
                                <div class="quick-view-tab-content tab-content">
                                    <div class="tab-pane active show fade" id="modal1" role="tabpanel">
                                        <img src="{{ asset('assets/frontend/') }}/img/quick-view/l1.jpg" alt="">
                                    </div>
                                    <div class="tab-pane fade" id="modal2" role="tabpanel">
                                        <img src="{{ asset('assets/frontend/') }}/img/quick-view/l2.jpg" alt="">
                                    </div>
                                    <div class="tab-pane fade" id="modal3" role="tabpanel">
                                        <img src="{{ asset('assets/frontend/') }}/img/quick-view/l3.jpg" alt="">
                                    </div>
                                </div>
                            </div>
                            <div class="quick-view-list nav" role="tablist">
                                <a class="active" href="#modal1" data-toggle="tab" role="tab">
                                    <img src="{{ asset('assets/frontend/') }}/img/quick-view/s1.jpg" alt="">
                                </a>
                                <a href="#modal2" data-toggle="tab" role="tab">
                                    <img src="{{ asset('assets/frontend/') }}/img/quick-view/s2.jpg" alt="">
                                </a>
                                <a href="#modal3" data-toggle="tab" role="tab">
                                    <img src="{{ asset('assets/frontend/') }}/img/quick-view/s3.jpg" alt="">
                                </a>
                            </div>
                        </div>
