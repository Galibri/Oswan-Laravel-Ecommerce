            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col text-center">
                        <a href="{{ route('admin.coupon.export_to_excel') }}"
                            class="btn btn-success">{{ __('Excel') }}</a>
                        <a href="{{ route('admin.coupon.export_to_csv') }}" class="btn btn-info">{{ __('CSV') }}</a>
                        <a href="{{ route('admin.coupon.export_to_pdf') }}" class="btn btn-primary">{{ __('PDF') }}</a>
                    </div>
